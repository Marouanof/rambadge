...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    long countByDirectionIdAndRole(Long directionId, UserRole role);
    long countByDirectionIdAndStatut(Long directionId, UserStatut statut);
    long countByDirectionIdAndRoleAndStatut(Long directionId, UserRole role, UserStatut statut);
    ...
    List<User> findByRoleAndStatut(UserRole role, UserStatut statut);
